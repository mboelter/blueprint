...
/* global EJS */
/* global $ */
var MarkdownStructure = function(json) {
  this.type = 'markdown';
  json = json || {};
...
MarkdownStructure.prototype = {
  createEl: function() {
    var html = new EJS({element: 'tmpl-markdown-structure'}).render({
      title: this.title,
      name: this.name,
  ...
  bind: function() {
    ...
    this.$el.find('textarea[name="placeholder"]').keyup(function() {
